package com.app.coronavairuss.DatosMundiales.Vista;
...
import com.app.coronavairuss.DatosMundiales.Adaptador.ListCountriesAdapter;
import com.app.coronavairuss.DatosMundiales.Modelo.CountryLine;
...
public class DatostiempoReal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_datostiempo_real);
        ...
        getSupportActionBar().setTitle("Datos Tiempo Real");
        ...
        listViewCountries.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(allCountriesResults.get(position).getCountryName().contains("Germany")){ //si se le da click a alemania aparecen datos de sus provicias
                            ...
                            try {
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        new AlertDialog.Builder(DatostiempoReal.this)
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    @Override
                                    public void run() {
                                        Toast.makeText(DatostiempoReal.this, "Network Connection Error!",
...
//Coronavirus - Datos en tiempo real
    void refreshData() {
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (cols.get(0).text().contains("Country") ) { //esta espara la fila
                            ...
                            while (rowIterator.hasNext()) {//esta es para la columna
                                row = rowIterator.next();
                                cols = row.select("td");
                        ...
                        //    calculate_percentages();
                            ...
                            myCalender = Calendar.getInstance();
                            textViewDate.setText("Ultima Actualización: " + myFormat.format(myCalender.getTime()));
                        }
                    });
                }
                catch (Exception ex) {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        @Override
                        public void run() {
                              Toast.makeText(DatostiempoReal.this, "Conexión a internet lenta, recargue de nuevo.",
                                    Toast.LENGTH_LONG).show();
                        }
                    });
                }
        ...
        if (isOnline(DatostiempoReal.this)) {
            final LottieAnimationView animacion2 = findViewById(R.id.Animacion2);
